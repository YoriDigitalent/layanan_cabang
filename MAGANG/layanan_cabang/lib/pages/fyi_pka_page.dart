...
class FyiPKAPage extends StatefulWidget {
  final Formulir formulir;

  FyiPKAPage({this.formulir});
  @override
  _FyiPKAPageState createState() => _FyiPKAPageState();
}

class _FyiPKAPageState extends State<FyiPKAPage> {
  @override
      ...
      body: Container(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Text(
              "Jika Kartu ATM Anda hilang, harap membawa Surat Kehilangan",
              style: orangeTextFont.copyWith(
                  fontSize: 16, fontWeight: FontWeight.bold),
              textAlign: TextAlign.left,
            ),
